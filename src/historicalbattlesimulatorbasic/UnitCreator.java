...
//        
        ...
        prompt[1]="Enter the type of unit[numerical]";
        ...
        prompt[14]="Enter unit x position";
        prompt[15]="Enter unit y position";
//
...
//            //if user ever enters exit, it ends
    /*  if(!stats[i].equals("exit")) 
           ...
           Unit unit = new Unit(soldier,
                   Integer.parseInt(stats[13]),//UnitSize
                   Integer.parseInt(stats[14]),//Unit x position
                   Integer.parseInt(stats[15])); //unit y position
           saveUnit(unit);
           return unit;
           }
